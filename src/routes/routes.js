...
router.route('/engineer/avatar/:id').put(uploadmiddleware.uploadShowcase, engineerCon.updateShowcase)
...
router.route('/company/avatar/:id').put(uploadmiddleware.upload, companyCon.updateLogo)
